...
import { useGetOthersProductQuery } from "@/redux/features/products/productsApi";

const BuilderOthersPage = () => {
  const { data, isLoading } = useGetOthersProductQuery();
  ...
  return (
    <div className="py-20 font-[Poppins]">
      <h1 className="text-left md:ml-20 ml-20 text-3xl mt-5 text-sky-500 mb-5">
        Others ({data?.data?.length} Products Found)
      </h1>
...
export default BuilderOthersPage;

BuilderOthersPage.getLayout = function getLayout(page) {
