...
const BuilderStorageDevicePage = () => {
  const { data, isLoading } = useGetStorageDeviceProductQuery();
  ...
  return (
    <div className="py-20 font-[Poppins]">
      <h1 className="text-left md:ml-20 ml-20 text-3xl mt-5 text-sky-500 mb-5">
        Storage Device ({data?.data?.length} Products Found)
      </h1>
...
export default BuilderStorageDevicePage;

BuilderStorageDevicePage.getLayout = function getLayout(page) {
