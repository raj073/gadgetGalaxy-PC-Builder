...
const BuilderMotherboardPage = () => {
  const { data, isLoading } = useGetMotherboardProductQuery();
  ...
  return (
    <div className="py-20 font-[Poppins]">
      <h1 className="text-left md:ml-20 ml-20 text-3xl mt-5 text-sky-500 mb-5">
        Motherboard ({data?.data?.length} Products Found)
      </h1>
...
export default BuilderMotherboardPage;

BuilderMotherboardPage.getLayout = function getLayout(page) {
